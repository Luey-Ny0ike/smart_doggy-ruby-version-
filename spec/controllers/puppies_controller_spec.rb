...
RSpec.describe PuppiesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      puppy = Puppy.create! valid_attributes
      get :show, params: {id: puppy.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      puppy = Puppy.create! valid_attributes
      get :edit, params: {id: puppy.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested puppy" do
        puppy = Puppy.create! valid_attributes
        put :update, params: {id: puppy.to_param, puppy: new_attributes}, session: valid_session
        puppy.reload
      ...
      it "redirects to the puppy" do
        puppy = Puppy.create! valid_attributes
        put :update, params: {id: puppy.to_param, puppy: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        puppy = Puppy.create! valid_attributes
        put :update, params: {id: puppy.to_param, puppy: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested puppy" do
      puppy = Puppy.create! valid_attributes
      expect {
        delete :destroy, params: {id: puppy.to_param}, session: valid_session
      }.to change(Puppy, :count).by(-1)
    end
